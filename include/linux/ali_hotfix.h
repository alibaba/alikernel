/*
 * ali_hotfix.h - Alibaba abstraction hotfix header
 *
 * We don't care about kabi for modules.
 *
 * Copyright (c) 2017 Xunlei Pang <xunlei.pxl@alibaba-inc.com>
 *
 ...
 */
#define ALI_HOTFIX_USE(n, _new)		ALI_HOTFIX_REPLACE(_ALI_HOTFIX_RESERVE(n), _new)
#define ALI_HOTFIX_USE_P(n, _new)	ALI_HOTFIX_REPLACE(_ALI_HOTFIX_RESERVE_P(n), _new)

/*
 * Macros for breaking up a reserved element into two smaller chunks using an
 * anonymous struct inside an anonymous union.
 */
#define ALI_HOTFIX_USE2(n, _new1, _new2)	ALI_HOTFIX_REPLACE(_ALI_HOTFIX_RESERVE(n), struct{ _new1; _new2; })
#define ALI_HOTFIX_USE2_P(n, _new1, _new2)	ALI_HOTFIX_REPLACE(_ALI_HOTFIX_RESERVE_P(n), struct{ _new1; _new2; })
